...
class Taxi24PassengerLanguages extends MyLanguages {
  @override
  Map<String, Map<String, String>> get keys {
    ...
    addString(
      ...
      enValue: 'Become a client with taxi24',
      arValue: 'كن عميلا مع  تاكسى24',
    );
    addString(
      key: LangEnum.onboardTitle2.name,
      enValue: 'Special prices, especially for each category',
      arValue: 'اسعار مميزة وخاصة كل فئة',
    );
    addString(
    ...
    addString(
      ...
      arValue: 'مزايا رائعة عندما تصبح عميلا مع  تاكسى24.',
      enValue:
    ...
    addString(
      ...
      enValue:
          'You can choose the appropriate category for you and the lowest price for the trip',
      arValue: 'يمكنك الاختيار الفئة المناسبة لك وباقل سعر للرحلة',
    );
    addString(
      key: LangEnum.onboardDes2.name,
      enValue:
          'You can choose your destination and the driver will be available to you as quickly and easily as possible',
      arValue: 'يمكنك اختيار وجهتك ويتوفر لك السائق فى اسرع وقت وبكل سهولة',
    );

    addString(
      key: LangEnum.welcomeTitle.name,
      enValue: 'Welcome to Taxi 24/7 Passenger',
      arValue: 'مرحبا بكم في راكب تاكسى 24/7',
    );

    addString(
      key: LangEnum.welcomeDes.name,
      enValue:
          'We get you anywhere with affordable and competitive prices.',
      arValue: 'نصلك إلى أي مكان وبأسعار مناسبة وتنافسية.',
    );
    ...
    addString(
      key: LangEnum.chooseRide.name,
      enValue: 'Choose a ride',
      arValue: 'اختر رحلة',
    );
    addString(
      key: LangEnum.confirmPickLocation.name,
      enValue: 'Confirm pickup location',
    ...
    addString(
      ...
      enValue: 'Searching for the nearest captain🚕..',
      arValue: 'جاري البحث عن أقرب كابتن🚕 ..',
    );
    addString(
