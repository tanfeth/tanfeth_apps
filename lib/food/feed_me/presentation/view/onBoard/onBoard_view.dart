...
class FeedMeOnBoardingView extends ConsumerStatefulWidget {
  const FeedMeOnBoardingView({super.key});

  @override
  ConsumerState<FeedMeOnBoardingView> createState() => _OnBoardingViewState();
}

class _OnBoardingViewState extends ConsumerState<FeedMeOnBoardingView> {
