...
class FeedMeLanguages extends MyLanguages {
  @override
  Map<String, Map<String, String>> get keys {
    ...
    addString(
      ...
      arValue: 'مزايا رائعة وعمولات اضافية عندما تصبح مندوبًا مع  اكلنى.',
      enValue:
    ...
    addString(
      ...
      enValue: 'Feed me 2024 ©, all rights reserved',
    ...
    addString(
      key: LangEnum.sweets.name,
      enValue: 'Sweets',
      arValue: 'حلويات',
    );
    addString(
      key: LangEnum.cheese.name,
      enValue: 'Cheese',
      arValue: 'جبن',
    );

    addString(
      key: LangEnum.italy.name,
      enValue: 'Italy',
      arValue: 'اكل ايطالى',
    );
    addString(
      key: LangEnum.drinks.name,
      enValue: 'Drinks',
      arValue: 'مشروبات',
    );
    addString(
      key: LangEnum.pizza.name,
      enValue: 'Pizza',
      arValue: 'بيتزا',
    );
    addString(
      key: LangEnum.burger.name,
      enValue: 'Burger',
      arValue: 'برجر',
    );
    addString(
      key: LangEnum.sandwich.name,
      enValue: 'Sandwich',
      arValue: 'ساندويتش',
    );
    addString(
      key: LangEnum.bety.name,
      enValue: 'Bety',
      arValue: 'اكل بيتي',
    );
    addString(
      key: LangEnum.shawarma.name,
      enValue: 'Shawarma',
      arValue: 'شاورما',
    );
    addString(
      key: LangEnum.asia.name,
      enValue: 'Asia',
      arValue: 'اكل اسيوى',
    );
    addString(
