...
extension ElevatedButtonEx on ButtonStyle {
  ButtonStyle? SecondaryElevatedButton(BuildContext context) {
    return copyWith(
      foregroundColor:
          WidgetStateProperty.all<Color?>(context.color.onSecondary),
      backgroundColor:
  ...
  ButtonStyle? GreyElevatedButton(BuildContext context) {
    return copyWith(
      foregroundColor:
          WidgetStateProperty.all<Color?>(context.color.onPrimaryContainer),
      backgroundColor:
          WidgetStateProperty.all<Color?>(context.color.primaryContainer),
    );
  }
  ...
  ButtonStyle? GreyOutlinedButton(BuildContext context) {
    return copyWith(
      ...
      side: WidgetStateProperty.all<BorderSide>(
          BorderSide(color: context.color.outline, width: 2)),
    );
  }
  ...
  ButtonStyle? DarkTextButton(BuildContext context) {
    return copyWith(
      ...
      overlayColor: WidgetStateProperty.all<Color?>(
          context.color.onPrimaryContainer.withOpacity(.05)),
    );
  }
}
...
extension SecondaryElevatedButton on ButtonStyle {
  ButtonStyle? secondaryElevatedButton(BuildContext context) {
    return copyWith(
      ...
      overlayColor: WidgetStateProperty.all<Color?>(
          context.color.onSecondary.withOpacity(.1)),
    );
  }
}
