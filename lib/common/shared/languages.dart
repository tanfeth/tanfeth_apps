...
enum LangEnum {
  ...
  rejectTitle,rejectMassage,pendingTitle,pendingMassage,
   codeSentSuccess, areSureWantLogout, takePhotoYourself,
  needPhotoVerifyYou, faceCameraDirectlyWithEyes,
  photoFocusFreeGlare, uploadphotoSaudiID,
  sureIDValidNotExpired,
  photoNotBlurryInformationReadable,
