...
import 'package:tanfeth_apps/travel/taxi24/taxi24_passenger/presentation/view/layout/layout_view.dart';
  ...
  static RoutingConfig config() {
    switch (customAppFlavor.appNameEnum) {
      case AppNameEnum.taxi24Driver:
        ...
        default:
        return RoutingConfig(path: _path, widget: const TaxiPassengerLayoutView());
    }
  }
}